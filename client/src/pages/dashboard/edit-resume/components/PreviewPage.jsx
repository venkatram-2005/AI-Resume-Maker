...
import CertificationPreview from "./preview-components/CertificationPreview";
import AchievementPreview from "./preview-components/AchievementPreview";
...
function PreviewPage() {
  ...
  return (
    ...
    >
      ...
      {resumeData?.certifications && <CertificationPreview resumeInfo={resumeData} />}
      {resumeData?.achievements && <AchievementPreview resumeInfo={resumeData} />}
    </div>
  );
}
